...
const ContactHero = () => {
  ...
  const titles = useMemo(
    () => ["closer", "connected", "better", "empowered", "supported"],
    []
  );
    ...
    <section className="bg-gradient-to-b from-primary/10 to-background px-5 sm:px-10 md:px-16 lg:px-20">
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-center gap-10 py-20 lg:py-32">
          ...
          <Badge
            variant="outline"
            className="group mb-4 flex w-fit items-center gap-2 border-primary/20 bg-primary/10 px-4 py-2 text-sm font-medium text-primary hover:bg-primary/20"
          >
          ...
          <div className="flex flex-col gap-6 text-center">
            <h1 className="font-regular max-w-3xl text-center text-4xl font-medium tracking-tight text-foreground md:text-5xl lg:text-7xl">
              <span className="text-gray-900">Let&apos;s get</span>
            ...
            <p className="max-w-2xl mx-auto text-lg leading-relaxed tracking-tight text-gray-600 md:text-xl">
              Whether you have a question, an idea, or simply want to explore
              how we can work together - we&apos;re here to listen. Our team values
              meaningful connections, and every message brings us closer to
              creating something impactful. Reach out today, and let&apos;s start
              building together.
            </p>
          </div>
