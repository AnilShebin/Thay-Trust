      ...
      <div className="mx-auto max-w-7xl ">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <p className="text-lg text-muted-foreground">
            With over twenty years of experience and many successful projects completed, we know how
            to help you design the best version of your product yet. We don&apos;t bite.{' '}
